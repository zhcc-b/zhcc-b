...
Software developer focused on systems, data, and full-stack product engineering.
...
- Languages: C/C++, Java, Kotlin, Python, JavaScript, TypeScript, SQL, Bash
- Backend: Spring Boot, Django, Flask, REST APIs, JWT, PostgreSQL, Redis, .NET
- Frontend: React, Vue, Dash, Plotly, Material UI, Bootstrap, Next.js
- Infra and tools: Git, Linux, Docker, AWS, Azure, Kubernetes, Jenkins, CI/CD

## Selected Projects

- [MySH](https://github.com/zhcc-b/mysh): Unix-like shell in C with pipelines, background jobs, variables, and TCP client/server support
...
- Personal site: [zhcc-b.github.io/Ben_web](https://zhcc-b.github.io/Ben_web/)

## Contact

- Email: [zhcc100@gmail.com](mailto:zhcc100@gmail.com)
- LinkedIn: [hongsheng-zhong](https://www.linkedin.com/in/hongsheng-zhong/)
